  ...
  try {
    ...
    if (server.host === '0.0.0.0') {
      return res.json({
        ...
        heartbeatMap: server.heartbeatMap ?? null,
        heartbeatConnectedPlayers: server.heartbeatConnectedPlayers ?? null,
        heartbeatTrackingPlayers: server.heartbeatTrackingPlayers ?? null,
        heartbeatReadyPlayers: server.heartbeatReadyPlayers ?? null,
        heartbeatPaused: server.heartbeatPaused ?? null,
        heartbeatSimulated: server.heartbeatSimulated ?? null,
