...
export class ServerService {
  ...
  private toResponse(server: Server): ServerResponse {
    ...
    return {
      ...
      heartbeatStatus: server.heartbeat_status ?? null,
      heartbeatMatchSlug: server.heartbeat_match_slug ?? null,
      heartbeatMatchid: server.heartbeat_matchid ?? null,
      heartbeatReadyForAllocation:
        typeof server.heartbeat_ready_for_allocation === 'number'
          ? server.heartbeat_ready_for_allocation === 1
