    ...
    commands: [
      {
        ...
        label: 'List Plugins',
        command: 'custom',
        description: 'List all installed CounterStrikeSharp plugins and their status.',
      },
      {
        id: 'plugins-load',
        label: 'Load Plugin',
        command: 'custom',
        description: 'Load a CounterStrikeSharp plugin by name.',
        requiresInput: true,
      ...
      },
      {
        ...
        label: 'Unload Plugin',
        command: 'custom',
        description: 'Unload a CounterStrikeSharp plugin by name.',
        requiresInput: true,
        inputLabel: 'Plugin name',
        inputType: 'text',
        color: 'error',
      },
      {
        ...
        label: 'Reload Plugin',
        command: 'custom',
        description: 'Reload a CounterStrikeSharp plugin by name.',
        requiresInput: true,
        inputLabel: 'Plugin name',
        inputType: 'text',
        color: 'warning',
